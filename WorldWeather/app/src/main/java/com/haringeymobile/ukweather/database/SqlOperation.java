...
public class SqlOperation {
	...
	/**
	 * The name of the {@link com.haringeymobile.ukweather.database.CityTable} column holding weather information as a
	 * JSON string.
	 */
	private String columnNameForJsonString;
	/**
	 * The name of the {@link com.haringeymobile.ukweather.database.CityTable} column holding the time for the last
	 ...
	 * 
	 * @param cursor
	 *            a cursor pointing to the {@link com.haringeymobile.ukweather.database.CityTable} row with cached
	 *            weather data
	...
	/**
	 * Removes the specified city record from the {@link com.haringeymobile.ukweather.database.CityTable}.
	 * 
	 * @param cityId
	 *            Open Weather Map city ID
	 */
	...
	/**
	 * Changes the name of the specified city in the {@link com.haringeymobile.ukweather.database.CityTable}.
	 * 
	 * @param cityId
	 *            Open Weather Map city ID
	 * @param newName
